...
//Bebop m=0.450
//Bebop2 m=0.500
float h=0.0, hdes=1.50;
float m = 0.450, g = 9.81,e0 = 0.0,e,dz,u,a0 = 0, th=0.0, phi=0.0;
...
int main (int argc, char **argv){
	...
	//Suscriber
	ros::Subscriber Alt = node_obj.subscribe("/bebop/states/ardrone3/PilotingState/AltitudeChanged",1,altitude_callback);
